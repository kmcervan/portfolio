        ...
        <section id='top' className='main-container'>
                ...
                <div className='main-text'> 
                    ...
                    <div>
                        ...
                        </a><a href='https://github.com/kmcervan' className='contact-link'>
                            <img className='link-img' src={Git}/>
                        </a><a href='https://twitter.com/Karla_mc4' className='contact-link'>
                            <img className='link-img' src={Eight}/>
                        </a><a href='mailto:cervantes.karla14@gmail.com' className='contact-link'>
